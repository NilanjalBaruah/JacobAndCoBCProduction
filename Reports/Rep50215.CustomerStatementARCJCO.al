report 50215 "Customer Statement ARCJCO"
{
    Caption = 'JCO Customer Statement';
    DefaultRenderingLayout = "CustomerStatementARCJCO.docx";
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                //JCO>>
                column(CustoLedgEntryDocTypeCaption; CustLedgEntry2.FieldCaption("Document Type"))
                {
                }
                column(CustLedgEntryDebitAmtCaption; CustLedgEntry2.FieldCaption("Debit Amount"))
                {
                }
                column(CustLedgEntryCreditAmtCaption; CustLedgEntry2.FieldCaption("Credit Amount"))
                {
                }
                //JCO<<
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(CreditAmt_DtldCustLedgEntries; "Credit Amount")
                            {
                            }
                            //JCO<<
    ...
    rendering
    {
        layout("CustomerStatementARCJCO.rdl")
        {
            Type = RDLC;
            LayoutFile = './CustomerStatementARCJCO.rdl';
            Caption = 'Customer Statement (RDL)';
            Summary = 'The Customer Statement (RDL) provides a detailed layout.';
        }
        layout("CustomerStatementARCJCO.docx")
        {
            Type = Word;
            LayoutFile = './CustomerStatementARCJCO.docx';
        ...
        {
            Type = Word;
            LayoutFile = './CustomerStatementEmailARCJCO.docx';
    ...
    begin
        ...
        SupportedOutputMethod := SupportedOutputMethod::PDF;
        //JCO<<
    ...
    var
        ...
        YourReference: Text;
        EntriesLbl: Label 'Starting Entries %1', Comment = '%1 = Currency code';
