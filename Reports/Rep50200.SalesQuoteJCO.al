        ...
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    FormattedTagPrice := Format(TagPrice, 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, CurrencyCode));
                    ...
                    FormattedTagPrice := CurrencySymbol + FormattedTagPrice;
