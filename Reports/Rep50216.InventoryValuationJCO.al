report 50216 "Inventory Valuation JCO"
{
    DefaultRenderingLayout = "InventoryValuationJCO.rdlc";
    ApplicationArea = All;
    Caption = 'Inventory Valuation (JCO)';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            RequestFilterFields = "No.", "Inventory Posting Group", "Costing Method", "Location Filter", "Variant Filter", "Item Category Code";
    ...
    rendering
    {
        layout("InventoryValuationJCO.rdlc")
        {
            Type = RDLC;
            LayoutFile = './InventoryValuationJCO.rdl';
            Caption = 'Inventory Valuation (RDL)';
            Summary = 'The Inventory Valuation (JCO) (RDL) provides a detailed layout.';
        }
    }
    labels
    {
