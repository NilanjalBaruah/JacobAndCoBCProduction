...
report 50202 "Sales - Memo JCOARC"
{
    Caption = 'Memo';
    DefaultRenderingLayout = "SalesMemo.rdlc";
        ...
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                var
                    ...
                    ConsignmentDetail: Record "Consignment Detail ARCJCO";
                ...
                begin
                    ...
                    if Type = Type::Item then begin
                        ...
                        ConsignmentDetail.SetRange("Document Type", Line."Document Type");
                        ConsignmentDetail.SetRange("Document No.", Line."Document No.");
                        ConsignmentDetail.SetRange("Document Line No.", Line."Line No.");
                        ConsignmentDetail.SetFilter("Serial No.", '<>%1', '');
                        if ConsignmentDetail.FindSet() then begin
                            repeat
                                if SerialNumberText <> '' then
                                    SerialNumberText := SerialNumberText + ' ,' + ConsignmentDetail."Serial No."
                                else
                                    SerialNumberText := ConsignmentDetail."Serial No.";
                            until ConsignmentDetail.Next() = 0;
                            case ConsignmentDetail.Count of
                                1:
    ...
    rendering
    {
        layout("SalesMemo.rdlc")
        {
            Type = RDLC;
            LayoutFile = './SalesMemoJCO.rdl';
            Caption = 'Sales Memo (RDL)';
            Summary = 'The Sales Memo (RDL) provides a detailed layout.';
        }
    }
    ...
    var
        ...
        DocumentTitleLbl: Label 'MEMO NO.';
