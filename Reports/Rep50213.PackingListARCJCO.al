...
report 50213 "Packing List JCOARC"
{
    Caption = 'Packing List';
    DefaultRenderingLayout = "PackingList.rdlc";
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            RequestFilterHeading = 'Packing List';
    ...
    rendering
    {
        layout("PackingList.rdlc")
        {
            Type = RDLC;
            LayoutFile = './PackingListARCJCO.rdl';
            Caption = 'Packing List (RDL)';
            Summary = 'The Packing List (RDL) provides a detailed layout.';
        }
    }
    ...
    var
        ...
        DocumentTitleLbl: Label 'PACKING NO.';
